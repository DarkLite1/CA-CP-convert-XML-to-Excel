...
<#
    .SYNOPSIS
        Run a script block over a collection, in parallel or not.

    .DESCRIPTION
        Taken from the Permission-matrix project, unchanged, so a fix made in
        either place still applies to both.
#>
