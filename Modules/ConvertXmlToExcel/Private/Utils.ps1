...
<#
    ...
    .DESCRIPTION
        Taken from the Permission-matrix project. Get-StringValueHC is what
        makes 'ENV:MY_VARIABLE' work in the configuration file, so secrets do
        not have to be stored in the .json file itself.
#>
